...
// FIX: Updated ButtonProps to extend from `React.ComponentProps<typeof motion.button>` instead of `React.ButtonHTMLAttributes<HTMLButtonElement>`.
// This resolves a type conflict with framer-motion's animation-related props.
interface ButtonProps extends Omit<React.ComponentProps<typeof motion.button>, 'children'> {
  children: React.ReactNode;
  variant?: 'primary' | 'secondary' | 'danger';
  // FIX: Added size prop to allow for different button sizes.
  size?: 'sm' | 'md' | 'lg';
  className?: string;
